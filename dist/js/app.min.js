...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/* harmony import */ var _ui_swiper_region_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ui/swiper-region.js */ \"./src/js/ui/swiper-region.js\");\n/* harmony import */ var _ui_burger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ui/burger.js */ \"./src/js/ui/burger.js\");\n/* harmony import */ var _ui_swiper_buttons_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ui/swiper-buttons.js */ \"./src/js/ui/swiper-buttons.js\");\n/* harmony import */ var _ui_portfolio_slider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui/portfolio-slider.js */ \"./src/js/ui/portfolio-slider.js\");\n/* harmony import */ var _ui_accordion_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui/accordion.js */ \"./src/js/ui/accordion.js\");\n/* harmony import */ var _ui_siper_port_web_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ui/siper-port-web.js */ \"./src/js/ui/siper-port-web.js\");\n/* harmony import */ var _modules_forms_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/forms.js */ \"./src/js/modules/forms.js\");\n\r\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n\r\n\r\n\r\n(0,_ui_portfolio_slider_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])()\r\n;(0,_ui_burger_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\r\n\r\n//импорт меню аккордеон\r\n\r\n\r\n\r\n(0,_ui_accordion_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\r\n(0,_ui_siper_port_web_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])()\r\n//import tabs from \"./ui/tabs.js\";\r\n//tabs(triggerClass, contentClass);\r\n\r\n//import DynamicAdapt from \"./modules/dynamicadapt.js\";\r\n//const da = new DynamicAdapt(\"max\");\r\n//da.init();\r\n\r\n// импорт модуля форм\r\n;\r\n//forms();\r\nconst header = document.querySelector(\"header\")\r\nconst main = document.querySelector(\"main\");\r\n\r\nmain.style.marginTop = `${header.offsetHeight}px`;\r\nwindow.addEventListener(\"resize\", () => {\r\n\tmain.style.marginTop = `${header.offsetHeight}px`;\r\n})\r\n\r\ndocument.addEventListener(\"DOMContentLoaded\", () => {\r\n\tlet currentPage = window.location.pathname.split(\"/\").pop();\r\n\r\n\tlet menuItems = document.querySelectorAll(\".menu__link\");\r\n\r\n\tmenuItems.forEach(item => {\r\n\t\tif(item.getAttribute(\"href\") === currentPage) {\r\n\t\t\titem.classList.add(\"_active\");\r\n\t\t} else {\r\n\t\t\titem.classList.remove(\"_active\");\r\n\t\t}\r\n\t})\r\n})\r\n\r\nwindow.addEventListener(\"resize\", _ui_accordion_js__WEBPACK_IMPORTED_MODULE_7__.activeAcccirdion)\r\n\r\n\r\nfunction onChangePositionArrow() {\r\n\tconst imageElements = document.querySelectorAll('.list-arrow__image');\r\n\timageElements.forEach((imageElement, index) => {\r\n\r\n\t\tconst nextImageElement = imageElements[index + 1];\r\n\t\r\n\r\n\t\tif (nextImageElement) {\r\n\t\t\tconst difference = nextImageElement.getBoundingClientRect().top - imageElement.getBoundingClientRect().top;\r\n\t\t\tconst arrowBottomElement = imageElement.querySelector('.list-arrow__arroa-bottom');\r\n\t\r\n\t\t\tif (arrowBottomElement) {\r\n\t\t\t\t\r\n\t\t\t\tif((difference > 116) && (difference < 125)){\r\n\t\t\t\t\tarrowBottomElement.style.bottom = `-${38}px`;\r\n\t\t\t\t} \r\n\t\t\t\tif ( difference < 118) {\r\n\t\t\t\t\tarrowBottomElement.style.bottom = `-${-32}px`;\r\n\t\t\t\t}  else {\r\n\t\t\t\t\tarrowBottomElement.style.bottom = `-${difference / 3.3}px`;\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t});\r\n}\r\n\r\nonChangePositionArrow()\r\nwindow.addEventListener(\"resize\", () => {\r\n\tonChangePositionArrow()\r\n})\r\n\r\n\r\n\r\ntry {\r\n\t;(0,_ui_swiper_region_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])( \".region__content\", \".region__items\", \".region__item\")\r\n\twindow.addEventListener('resize', () => {\r\n\t\t;(0,_ui_swiper_region_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])( \".region__content\", \".region__items\", \".region__item\");\r\n\t});\r\n} catch(e) {\r\n\tconsole.log(e)\r\n}\r\n\r\ntry {\r\n\t(0,_ui_swiper_buttons_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(\".main-blog__buttons\", \".filter-button__items\", \".filter-button__button\");\r\n} catch(e) {\r\n\tconsole.log(e)\r\n}\r\n\r\n\r\ntry {\r\n\tnew swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\".say__swiper\", {\r\n\t\tmodules: [ swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],\r\n\t\tgrabCursor:true,\r\n\t\tpagination:{\r\n\t\t\tel: '.say__pagination',\r\n\t\t\tdynamicBullets:true,\r\n\t\t},\r\n\t\tinitialSlide:3,\t\t\r\n\t\tbreakpoints: {\r\n\t\t\t220: {\r\n\t\t\t\tslidesPerView: 1,\r\n\t\t\t},\r\n\t\t\t630: {\r\n\t\t\t\tspaceBetween:30,\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t},\r\n\t\t\t767: {\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t\tspaceBetween:60,\r\n\t\t\t}\r\n\t\t}\r\n\t});\r\n} catch(e) {\r\n\tconsole.log(e)\r\n}\r\n\r\n\r\nconst buttonTop = document.querySelector(\".footer-top__button-top\");\r\n\r\nbuttonTop.addEventListener(\"click\", () => {\r\n\tscrollTo({\r\n\t\ttop:0,\r\n\t\tbehavior:\"smooth\"\r\n\t})\r\n})\r\n\r\nconst counters = document.querySelectorAll('.counter');\r\n\r\nfunction animateCounter(counter) {\r\n\tconst target = parseInt(counter.dataset.number);\r\n\tlet current = 0;\r\n\tconst step = Math.ceil(target / 100);\r\n\r\n\tconst interval = setInterval(() => {\r\n\t\tif (current < target) {\r\n\t\t\tcurrent += step;\r\n\t\t\tcounter.textContent = `${current}+`;\r\n\t\t} else {\r\n\t\t\tclearInterval(interval);\r\n\t\t\tcounter.removeAttribute(\"data-number\");\r\n\t\t\tcounter.classList.remove(\"counter\");\r\n\t\t\tcounter.classList.remove(\"_anim-items\");\r\n\t\t}\r\n\t}, 10);\r\n}\r\n\r\nfunction animNumbers() {\r\n\tcounters.forEach(counter => {\r\n\t\tif(counter.classList.contains(\"_active\")) {\r\n\t\t\tanimateCounter(counter);\r\n\t\t}\r\n\t});\r\n}\r\n\r\nconst element = document.querySelectorAll(\"[data-go]\");\r\n\r\nelement.forEach(item => {\r\n    item.addEventListener(\"click\", (e) => {\r\n        e.preventDefault()\r\n        let attribute = item.getAttribute(\"data-go\")\r\n        scrollTo({\r\n            top: document.querySelector(`${attribute}`).offsetTop - header.offsetHeight,\r\n            behavior:\"smooth\"\r\n        })\r\n    })\r\n})\r\n\r\n\r\n\r\nconst animItems = document.querySelectorAll(\"._anim-items\");\r\n\r\nif(animItems.length > 0) {\r\n\r\n    window.addEventListener(\"scroll\" , animOmScroll );\r\n    function animOmScroll() {\r\n        for(let index = 0; index < animItems.length; index++) {\r\n            const animItem = animItems[index];\r\n            const offsetHeight = offset(animItem).top;\r\n            const elementHeight = animItem.scrollHeight;\r\n            const animNumber = 4;\r\n\r\n            let startAnim = window.innerHeight - elementHeight/animNumber;\r\n            if(window.innerHeight > elementHeight) {\r\n                startAnim = window.innerHeight - elementHeight/animNumber;\r\n            }\r\n\r\n            if((scrollY > offsetHeight - startAnim) && scrollY < (offsetHeight + elementHeight)) {\r\n                animItem.classList.add(\"_active\");\r\n\t\t\t\tanimNumbers()\r\n            } else {\r\n\t\t\t\tif(!animItem.classList.contains(\"no-repeat-anim\")) {\r\n\t\t\t\t\tanimItem.classList.remove(\"_active\");\r\n\t\t\t\t}\r\n            }\r\n        }\r\n    }\r\n\r\n    function offset(el) {\r\n        const rect = el.getBoundingClientRect(),\r\n        scrollLeft = window.scrollX || document.documentElement.scrollLeft,\r\n        scrollTop = window.scrollY || document.documentElement.scrollTop;\r\n        return {top: rect.top + scrollTop, left: rect.left + scrollLeft};\r\n    }\r\n\r\n    setTimeout(()=> {\r\n        animOmScroll();\r\n    }, 300);\r\n}\r\n\r\nfunction onDeleteClass() {\r\n\tconst hoverLine = document.querySelectorAll(\".link-spoller__link\");\r\n\tif(window.innerWidth < 991.98) {\r\n\t\thoverLine.forEach(item => {\r\n\t\t\titem.classList.remove(\"hover-line\")\r\n\t\t})\r\n\t} else {\r\n\t\thoverLine.forEach(item => {\r\n\t\t\titem.classList.add(\"hover-line\")\r\n\t\t})\r\n\t}\r\n}\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst listItem = document.querySelectorAll(\"[data-transition\")\r\n\r\nfunction animListItem() {\r\n\tlistItem.forEach(list => {\r\n\t\tconst listClass = list.querySelectorAll(\"[data-tritems\");\r\n\t\tlet ease = 0.1;\r\n\t\r\n\t\tlistClass.forEach(item => {\r\n\t\t\titem.style.cssText = `transition: all 0.3s ease ${ease}s;`;\r\n\t\t\tease += 0.1;\r\n\t\t})\r\n\t})\r\n}\r\nanimListItem()\r\n\r\n\r\nconst headerSpoller = document.querySelector(\".menu__item-spoller\");\r\nconst listSpollerBlock = document.querySelector(\".link-spoller__body\")\r\nconst listSpoller = document.querySelector(\".link-spoller__list\")\r\nconst buttonSpollerOpeninHeader = document.querySelector(\"#link-spoller\");\r\nconst buttonMobileMenuHeader = document.querySelector(\".link-spoller__button\")\r\n\r\n\r\nfunction deleteClassInHeaderMenu() {\r\n\tlistSpollerBlock.classList.remove(\"_active\");\r\n\theaderSpoller.classList.remove(\"_active\");\r\n}\r\n\r\nbuttonMobileMenuHeader.addEventListener(\"click\",deleteClassInHeaderMenu )\r\nfunction resizeHeaderList () {\r\n\tlistSpollerBlock.style.top = `${header.offsetHeight}px`\r\n}\r\nresizeHeaderList();\r\n\r\n\r\n\r\nbuttonSpollerOpeninHeader.addEventListener(\"click\", () => {\r\n\tlistSpollerBlock.classList.toggle(\"_active\");\r\n\theaderSpoller.classList.toggle(\"_active\");\r\n})\r\n\r\n\r\nlet windowWidth = window.innerWidth;\r\n\r\nwindow.addEventListener(\"resize\", () => {\r\n\twindowWidth = window.innerWidth;\r\n})\r\nfunction onShowInHover() {\r\n\tif( windowWidth > 991.50) {\r\n\t\theaderSpoller.addEventListener(\"mouseenter\", () => {\r\n\t\t\tlistSpollerBlock.classList.add(\"_active\");\r\n\t\t\theaderSpoller.classList.add(\"_active\");\r\n\t\t})\r\n\t\theaderSpoller.addEventListener(\"mouseleave\", deleteClassInHeaderMenu)\r\n\t\tlistSpoller.addEventListener(\"mouseleave\", () => {\r\n\t\t\tlistSpollerBlock.classList.remove(\"_active\");\r\n\t\t})\r\n\t}\r\n}\r\nonShowInHover();\r\n\r\nlistSpollerBlock.addEventListener(\"click\", (e) => {\r\n\tif(e.target.classList.contains(\"link-spoller__body\")) {\r\n\t\tlistSpollerBlock.classList.remove(\"_active\");\r\n\t}\r\n})\r\n\r\n\r\nwindow.addEventListener(\"resize\", () => {\r\n\tresizeHeaderList();\r\n\tonDeleteClass();\r\n})\r\n\r\n\r\nfunction deleteClass() {\r\n\tlistSpollerBlock.classList.remove(\"_active\");\r\n\theaderSpoller.classList.remove(\"_active\");\r\n\theader.classList.remove(\"_active\");\r\n\tdocument.body.style.overflow = \"\";\r\n\tbuttonBurger.classList.remove(\"active\")\r\n}\r\n\r\n\r\nconst fonHeader = document.querySelector(\".block-fon\");\r\nconst buttonBurger = document.querySelector(\".ham8\")\r\n\r\nfonHeader.addEventListener(\"click\", deleteClass)\r\n\r\n\r\n\r\nlet startX, startY, endX, endY;\r\n\r\ndocument.addEventListener('touchstart', function(e) {\r\n    startX = e.touches[0].clientX;\r\n    startY = e.touches[0].clientY;\r\n}, false);\r\n\r\ndocument.addEventListener('touchend', function(e) {\r\n    endX = e.changedTouches[0].clientX;\r\n    endY = e.changedTouches[0].clientY;\r\n    handleSwipe();\r\n}, false);\r\n\r\nfunction handleSwipe() {\r\n    let deltaX = endX - startX;\r\n    let deltaY = endY - startY;\r\n    \r\n    if (Math.abs(deltaX) > Math.abs(deltaY) && deltaX > 0) {\r\n\t\tdeleteClass()\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   activeAcccirdion: () => (/* binding */ activeAcccirdion),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n\r\n\r\n//  data-spoller-trigger дата атрибут блоку на котором должен идти клик\r\n// data-spollers родительский блок, оболочка меню аккордеон\r\n// data-spollers-content  контент спойлера\r\n\r\n\r\nconst accordion = () => {\r\n\tconst trigger = document.querySelectorAll(\"[data-spoller-trigger]\");   \r\n\r\n\ttrigger.forEach(item => {\r\n\t\titem.addEventListener(\"click\", ()=> {\r\n\t\t\tconst parent = item.parentElement;\r\n\t\t\tparent.classList.toggle(\"active\");\r\n\t\t\tif(parent.classList.contains(\"active\")) {\r\n\t\t\t\titem.nextElementSibling.style.cssText = `\r\n\t\t\t\t\theight: ${item.nextElementSibling.scrollHeight}px;\r\n\t\t\t\t`;\r\n\t\t\t} else {\r\n\t\t\t\titem.nextElementSibling.style.cssText = `\t\r\n\t\t\t\t\theight: 0;\r\n\t\t\t\t`;\r\n\t\t\t}\r\n\t\t});\r\n\t});\r\n};\r\n\r\nconst activeAcccirdion = () => {\r\n\tconst triggers = document.querySelectorAll(\"[data-spoller-trigger]\");\r\n\ttriggers.forEach(item => {\r\n\t\tconst parent = item.parentElement;\r\n\t\tif(parent.classList.contains(\"active\")) {\r\n\t\t\tparent.classList.remove(\"active\");\r\n\t\t\titem.nextElementSibling.style.cssText = `\t\r\n\t\t\t\t\theight: 0;\r\n\t\t\t\t`;\r\n\t\t}\r\n\t})\r\n}\r\n\r\n/*\r\nconst accordion = () => {\r\n\tconst trigger = document.querySelectorAll(\"[data-spoller-trigger]\");   \r\n\tlet openAccordion = null; // Переменная для хранения открытого аккордеона\r\n\t\r\n\t// Функция для обновления высоты аккордеона\r\n\tconst updateAccordionHeight = () => {\r\n\t\tif (openAccordion) {\r\n\t\t\topenAccordion.nextElementSibling.style.height = openAccordion.nextElementSibling.scrollHeight + 10 + 'px';\r\n\t\t}\r\n\t};\r\n\r\n\ttrigger.forEach(item => {\r\n\t\titem.addEventListener(\"click\", ()=> {\r\n\t\t\tconst parent = item.parentElement;\r\n\t\t\tparent.classList.toggle(\"active\");\r\n\r\n\t\t\tif(parent.classList.contains(\"active\")) {\r\n\t\t\t\titem.nextElementSibling.style.cssText = `height: ${item.nextElementSibling.scrollHeight}px`;\r\n\t\t\t\topenAccordion = item; // Обновляем открытый аккордеон\r\n\t\t\t} else {\r\n\t\t\t\titem.nextElementSibling.style.cssText = `height: 0`;\r\n\t\t\t\topenAccordion = null; // Закрываем аккордеон\r\n\t\t\t}\r\n\t\t});\r\n\t});\r\n\t// Слушатель события изменения размера окна\r\n\twindow.addEventListener('resize', () => {\r\n\t  updateAccordionHeight(); // Обновляем высоту аккордеона при изменении размера окна\r\n\t});\r\n};\r\n*/\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (accordion);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/accordion.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction burgerMenu(){\r\n\tconst header = document.querySelector(\".header\");\r\n\tconst buttonBurger = document.querySelector(\".icon-menu\");\r\n\tconst listSpollerBlock = document.querySelector(\".link-spoller__body\");\r\n\tconst headerSpoller = document.querySelector(\".menu__item-spoller\");\r\n\tbuttonBurger.addEventListener(\"click\", ()=> {\r\n\t\tif(header.classList.contains(\"_active\")) {\r\n\t\t\theader.classList.remove(\"_active\");\r\n\t\t\tlistSpollerBlock.classList.remove(\"_active\");\r\n\t\t\theaderSpoller.classList.remove(\"_active\");\r\n\t\t\tdocument.body.style.overflow = \"\";\r\n\t\t} else {\r\n\t\t\theader.classList.add(\"_active\");\r\n\t\t\tdocument.body.style.overflow = \"hidden\";\r\n\t\t}\r\n\t});\r\n}\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (burgerMenu);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/burger.js?");

/***/ }),

/***/ "./src/js/ui/function.js":
/*!*******************************!*\
  !*** ./src/js/ui/function.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addSwiperClass: () => (/* binding */ addSwiperClass),\n/* harmony export */   removeSlidesClass: () => (/* binding */ removeSlidesClass)\n/* harmony export */ });\n\r\n\r\nfunction addSwiperClass(selectorSwiperAdd, selectorWrapperAdd, selectorSlidesAdd) {\r\n\t\r\n\tdocument.querySelector(selectorSwiperAdd).classList.add(\"swiper\");\r\n\tdocument.querySelector(selectorWrapperAdd).classList.add(\"swiper-wrapper\");\r\n\tdocument.querySelectorAll(selectorSlidesAdd).forEach(slide => {\r\n\t\tslide.classList.add(\"swiper-slide\");\r\n\t\tslide.style.cssText = \" width: auto; \";\r\n\t});\r\n}\r\nfunction removeSlidesClass(selectorSwiper, selectorWrapper, selectorSlides) {\r\n\tdocument.querySelector(selectorSwiper).classList.remove(\"swiper\");\r\n\tdocument.querySelector(selectorWrapper).classList.remove(\"swiper-wrapper\");\r\n\tdocument.querySelectorAll(selectorSlides).forEach(slide => {\r\n\t\tslide.classList.remove(\"swiper-slide\");\r\n\t\tslide.style.cssText = \" \";\r\n\t});\r\n}\r\n\r\n\r\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/function.js?");

/***/ }),

/***/ "./src/js/ui/portfolio-slider.js":
/*!***************************************!*\
  !*** ./src/js/ui/portfolio-slider.js ***!
  \***************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nfunction sliderPortfolio() {\r\n    let swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\".portfolio-slider__swiper-1\",{\r\n        modules:[swiper_modules__WEBPACK_IMPORTED_MODULE_0__.Controller],\r\n        \r\n\t\tspeed: 300,\r\n\t\tslidesPerGroup: 1,\r\n        breakpoints: {\r\n\t\t\t220: {\r\n\t\t\t\tslidesPerView: 1,\r\n                spaceBetween:15,\r\n\t\t\t},\r\n            387.98: {\r\n                spaceBetween:15,\r\n                slidesPerView: 2,\r\n            },\r\n            767.98: {\r\n                spaceBetween:25,\r\n                slidesPerView: 3,\r\n            },\r\n\t\t\t991.98: {\r\n                spaceBetween:30,\r\n\t\t\t\tslidesPerView: 4,\r\n\t\t\t},\r\n            1280.98: {\r\n                spaceBetween:40,\r\n\t\t\t\tslidesPerView: 4,\r\n\t\t\t}\r\n\r\n\t\t}\r\n    })\r\n    let swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\".portfolio-slider__swiper-2\",{\r\n        \r\n        modules:[swiper_modules__WEBPACK_IMPORTED_MODULE_0__.Controller, swiper_modules__WEBPACK_IMPORTED_MODULE_0__.Pagination],\r\n\t\tspeed: 300,\r\n        initialSlide:3,\t\r\n\t\tslidesPerGroup: 1,\r\n        breakpoints: {\r\n\t\t\t220: {\r\n\t\t\t\tslidesPerView: 1,\r\n                spaceBetween:15,\r\n\t\t\t},\r\n            387.98: {\r\n                spaceBetween:15,\r\n                slidesPerView: 2,\r\n            },\r\n            767.98: {\r\n                spaceBetween:25,\r\n                slidesPerView: 3,\r\n            },\r\n\t\t\t991.98: {\r\n                spaceBetween:30,\r\n\t\t\t\tslidesPerView: 4,\r\n\t\t\t},\r\n            1280.98: {\r\n                spaceBetween:40,\r\n\t\t\t\tslidesPerView: 4,\r\n\t\t\t}\r\n\t\t},\r\n        pagination:{\r\n            dynamicBullets:true,\r\n\t\t\tel: '.portfolio-slider__pagination',\r\n\t\t},\r\n        controller: {\r\n            control:swiper1,\r\n        },\r\n    })\r\n\r\n    swiper1.controller.control = swiper2;\r\n    swiper2.controller.control = swiper1;\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sliderPortfolio);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/portfolio-slider.js?");

/***/ }),

/***/ "./src/js/ui/siper-port-web.js":
/*!*************************************!*\
  !*** ./src/js/ui/siper-port-web.js ***!
  \*************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nfunction initSliderInWebPage() {\r\n    let swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\".web-slider-port__swiper-1\",{\r\n        modules:[swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Controller],\r\n        \r\n\t\tspeed: 300,\r\n\t\r\n        breakpoints: {\r\n\t\t\t220: {\r\n                slidesPerGroup: 1,\r\n\t\t\t\tslidesPerView: 1,\r\n                spaceBetween:15,\r\n\t\t\t},\r\n            427.98: {\r\n                spaceBetween:15,\r\n                slidesPerGroup: 2,\r\n                slidesPerView: 2,\r\n            },\r\n            767.98: {\r\n                spaceBetween:25,\r\n                slidesPerView: 2,\r\n            },\r\n\t\t\t991.98: {\r\n                spaceBetween:30,\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t},\r\n            1280.98: {\r\n                spaceBetween:40,\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t}\r\n\r\n\t\t}\r\n    })\r\n    let swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\".web-slider-port__swiper-2\",{\r\n        pagination:{\r\n\t\t\tel: '.web-slider-port__pagination',\r\n            dynamicBullets:true,\r\n\t\t},\r\n        modules:[swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Controller, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\r\n\t\tspeed: 300,\r\n        initialSlide:2,\t\r\n\t\t\r\n        breakpoints: {\r\n\t\t\t220: {\r\n\t\t\t\tslidesPerView: 1,\r\n                spaceBetween:15,\r\n                slidesPerGroup: 1,\r\n\t\t\t},\r\n            427.98: {\r\n                slidesPerGroup: 2,\r\n                spaceBetween:15,\r\n                slidesPerView: 2,\r\n            },\r\n            767.98: {\r\n                spaceBetween:25,\r\n                slidesPerView: 2,\r\n            },\r\n\t\t\t991.98: {\r\n                spaceBetween:30,\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t},\r\n            1280.98: {\r\n                spaceBetween:40,\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t}\r\n\t\t},\r\n        controller: {\r\n            control:swiper1,\r\n        },\r\n    })\r\n\r\n    swiper1.controller.control = swiper2;\r\n    swiper2.controller.control = swiper1;\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initSliderInWebPage);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/siper-port-web.js?");

/***/ }),

/***/ "./src/js/ui/swiper-buttons.js":
/*!*************************************!*\
  !*** ./src/js/ui/swiper-buttons.js ***!
  \*************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./function.js */ \"./src/js/ui/function.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n\r\n\r\n\r\n\r\n\r\nfunction comparsionButtons(swiperBlock, swiperWrapper,swiperSlides ) {\r\n\tif(window.innerWidth < 10000 ) {\r\n\t\r\n\t(0,_function_js__WEBPACK_IMPORTED_MODULE_0__.addSwiperClass)(swiperBlock, swiperWrapper,swiperSlides);\r\n\tnew swiper__WEBPACK_IMPORTED_MODULE_1__[\"default\"](swiperBlock, {\r\n\t\tkeyboard: {\r\n\t\t\tenabled: true,\r\n\t\t\tonlyInViewport: true,\r\n\t\t\tpageUpDown: true,\r\n\t\t},\r\n\t\tspaceBetween:10,\r\n\t\tspeed: 300,\r\n\t\tslidesPerGroup: 1,\r\n\t\tslidesPerView: \"auto\"\r\n\t});\r\n\t} else {\r\n\t\t(0,_function_js__WEBPACK_IMPORTED_MODULE_0__.removeSlidesClass)(swiperBlock, swiperWrapper,swiperSlides);\r\n\t}\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (comparsionButtons);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/swiper-buttons.js?");

/***/ }),

/***/ "./src/js/ui/swiper-region.js":
/*!************************************!*\
  !*** ./src/js/ui/swiper-region.js ***!
  \************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.mjs\");\n/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ \"./node_modules/swiper/modules/index.mjs\");\n/* harmony import */ var _function_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./function.js */ \"./src/js/ui/function.js\");\n\r\n\r\n\r\n\r\n\r\nfunction comparsion(swiperBlock, swiperWrapper,swiperSlides ) {\r\n\tif(window.innerWidth < 767.98 ) {\r\n\t\r\n\t(0,_function_js__WEBPACK_IMPORTED_MODULE_2__.addSwiperClass)(swiperBlock, swiperWrapper,swiperSlides);\r\n\tnew swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](swiperBlock, {\r\n\t\tmodules: [ swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],\r\n\t\tkeyboard: {\r\n\t\t\tenabled: true,\r\n\t\t\tonlyInViewport: true,\r\n\t\t\tpageUpDown: true,\r\n\t\t},\r\n\t\tspaceBetween:10,\r\n\t\tspeed: 300,\r\n\t\tslidesPerGroup: 1,\r\n\t\tpagination:{\r\n\t\t\tel: '.region-pagination',\r\n\t\t},\r\n\t\tbreakpoints: {\r\n\t\t\t220: {\r\n\t\t\t\tslidesPerView: 1,\r\n\t\t\t},\r\n\t\t\t420: {\r\n\t\t\t\tslidesPerView: 2,\r\n\t\t\t}\r\n\t\t}\r\n\t});\r\n\t} else {\r\n\t\t(0,_function_js__WEBPACK_IMPORTED_MODULE_2__.removeSlidesClass)(swiperBlock, swiperWrapper,swiperSlides);\r\n\t}\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (comparsion);\n\n//# sourceURL=webpack://gulp-2022/./src/js/ui/swiper-region.js?");
